...
**TL;DR:** Download [DoDCampaign.7z](https://github.com/protohuf/dod-campaign/releases/download/v2.0/DoDCampaign.7z) from the [release page](https://github.com/protohuf/dod-campaign/releases/tag/v2.0), then read the Installation instructions below very carefully
